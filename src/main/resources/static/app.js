...
var request = document.getElementById('city');
...
document.querySelector('form').addEventListener('submit', async (e) => {
    ...
    button.value = "Fetching..."
try{
    var search = await fetch(`https://geocoding-api.open-meteo.com/v1/search?name=${encodeURIComponent(request.value)}&count=1&language=en&format=json`);
    var object = await search.json();
